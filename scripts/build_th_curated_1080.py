"""Build the Thai 1,080-case set with JevBench-hard governance contrasts."""
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("data/th_curated_1080"))
    ...
    if len(rows) != 1380:
        raise SystemExit(f"expected 1380 authored rows, got {len(rows)}")
    ...
    expected = {"train": 1080, "validation": 100, "calibration": 100, "test": 100}
