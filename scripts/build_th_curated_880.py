"""Build the Thai 880-case set with paired ordinal boundary contrasts."""
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("data/th_curated_880"))
    ...
    if len(rows) != 1180:
        raise SystemExit(f"expected 1180 authored rows, got {len(rows)}")
    ...
    expected = {"train": 880, "validation": 100, "calibration": 100, "test": 100}
