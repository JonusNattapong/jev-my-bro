"""Build the Thai 960-case set with extra 1/2 and 2/3 contrasts."""
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("data/th_curated_960"))
    ...
    if len(rows) != 1260:
        raise SystemExit(f"expected 1260 authored rows, got {len(rows)}")
    ...
    expected = {"train": 960, "validation": 100, "calibration": 100, "test": 100}
